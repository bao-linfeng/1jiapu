        ...
        <div class="section section-2 section-3" id="2">
            <div class="content-box">
                <div class="genealogy-summary marginL205">
                    ...
                    <a target="_blank" :href="'https://youpu.qingtime.cn/account/?status=home&token='+(switchToken['28'] ? switchToken['28'] : '')"><img class="btn" src="../assets/BootPage/section_3_btn.png" alt=""></a>
                    <span class="note">注：平台仅供专业伙伴使用</span>
                </div>
                <div class="youpu-box">
                    <Cloud />
...
export default {
    ...
    setup(props, context) {
        ...
        const downloadList = ref([
            ...
            {'name': '安卓手机版', 'img': android, 'url': 'http://d.maps9.com/3buz'}
        ]);
